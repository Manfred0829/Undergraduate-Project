...
# 下載檔案
@upload_bp.route('/download/<file_type>/<subject>/<file_name>', methods=['GET'])
def download_file(file_type, subject, file_name):
    """下載檔案"""
    ...
    try:
        # 檔案路徑
        file_path = os.path.join("app", "data_upload", subject, file_type, file_name)
